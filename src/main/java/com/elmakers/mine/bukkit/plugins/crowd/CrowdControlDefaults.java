...
class CrowdControlDefaults
{
    ...
    public final String[] listCommand               = { "list", "List rules or creatures, or both", null };
    ...
    public final String[] listPopulationCommand     = { "population", "List the current population", "[world] [type]" };
    public final String   listPopulationMessage     = "Population in world %s:";
    public final String[] listRulesCommand          = { "rules", "List all rules applying to a world", "[world] [type] " };
